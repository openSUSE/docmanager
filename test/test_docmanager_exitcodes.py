...
def test_exitcodes_1(tmp_broken_xml):
    ...
    try:
        ...
        assert e.code == ReturnCodes.E_XML_PARSE_ERROR, "Expected exit code {} but got {}.".format(ReturnCodes.E_XML_PARSE_ERROR, e.code)
...
def test_exitcodes_2(tmp_invalid_db5_file):
    ...
    try:
        ...
        assert e.code == ReturnCodes.E_INVALID_XML_DOCUMENT, "Expected exit code {} but got {}.".format(ReturnCodes.E_INVALID_XML_DOCUMENT, e.code)