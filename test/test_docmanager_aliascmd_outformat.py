...
data = [ 
    ('json', '{"myfiles": "analyze -f", "amazing_alias": "get test/testfiles/valid_xml_file.xml", "my": "alias", "alias_format_test1": "alias1", "alias_format_test2": "alias2"}\n' ),
    ('xml', '<!DOCTYPE docmanager>\n<docmanager>\n  <aliases>\n    <alias name="myfiles">analyze -f</alias>\n    <alias name="amazing_alias">get test/testfiles/valid_xml_file.xml</alias>\n    <alias name="my">alias</alias>\n    <alias name="alias_format_test1">alias1</alias>\n    <alias name="alias_format_test2">alias2</alias>\n  </aliases>\n</docmanager>\n\n'),
    ('table', '+--------------------+---------------------------------------+\n| Alias              | Command                               |\n+--------------------+---------------------------------------+\n| myfiles            | analyze -f                            |\n| amazing_alias      | get test/testfiles/valid_xml_file.xml |\n| my                 | alias                                 |\n| alias_format_test1 | alias1                                |\n| alias_format_test2 | alias2                                |\n+--------------------+---------------------------------------+\n')
]
